  ...
  return (
    <div className={styles['not-found-page']}>
      ...
      <div className={styles['not-found-container']}>
        ...
        <h1 className={styles['error-title']}>CONTENT NOT FOUND</h1>
        ...
        <div className={styles['error-details']}>
          <div className={styles['detail-item']}>
            <span className={styles['detail-label']}>ERROR CODE:</span>
            <span className={styles['detail-value']}>404_NOT_FOUND</span>
          </div>
          <div className={styles['detail-item']}>
            <span className={styles['detail-label']}>STATUS:</span>
            <span className={styles['detail-value']}>RESOURCE UNAVAILABLE</span>
          </div>
        </div>

        <div className={styles['action-buttons']}>
          <Link href="/dashboard" className={styles['btn-primary']}>
            <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
              <path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"/>
            </svg>
            RETURN TO DASHBOARD
          </Link>
          <Link href="/discover" className={styles['btn-secondary']}>
            <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
