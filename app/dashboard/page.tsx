          ...
          <div className={styles['footer-links']}>
            ...
            <div className={styles['link-group']}>
              ...
              <div className={styles['social-icons']}>
                <a href="https://github.com/DevYoma" target="_blank" rel="noopener noreferrer" className={styles['social-icon']}>
                ...
                <a href="https://x.com/devYoma" target="_blank" rel="noopener noreferrer" className={styles['social-icon']}>
                  <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
